...
2. Create and push an annotated tag matching the version exactly:
   ...
   ```sh
   git tag -a agent-v0.12.0 -m 'InitPad Agent 0.12.0'
   git push origin agent-v0.12.0
   ```
...
```sh
cosign verify \
  --certificate-identity 'https://github.com/OWNER/REPOSITORY/.github/workflows/release-agent.yml@refs/tags/agent-v0.12.0' \

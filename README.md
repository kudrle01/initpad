...
| Část | Stav |
|---|---|
| Self-hosted platforma | Veřejný podepsaný release `0.2.4`; instalace, reboot, obnova, čisté updaty a fault rollback živě ověřeny, oprava recovery po restartu je připravená pro `0.2.5` |
